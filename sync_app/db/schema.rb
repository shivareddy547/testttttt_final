...
ActiveRecord::Schema.define(:version => 20151119055936) do
  ...
  create_table "overdue_unmanage_tasks_settings", :force => true do |t|
    t.integer "project_user_preference_id"
    t.string  "name"
    t.string  "trackers",                   :default => "[]"
    t.string  "statuses",                   :default => "[]"
  end
  ...
  create_table "project_user_preferences", :force => true do |t|
    t.integer "user_id",          :default => 0, :null => false
    t.integer "project_id",       :default => 0, :null => false
    t.text    "others"
    t.text    "save_text_editor"
  end
  ...
  create_table "wiki_book_chapters", :force => true do |t|
    t.integer  "book_id"
    t.integer  "parent_id"
    t.string   "wiki_page_title"
    t.float    "order_float"
  ...
  create_table "wiki_roles", :force => true do |t|
    t.integer "role"
